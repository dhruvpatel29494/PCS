...
public class UploadServlet extends HttpServlet {
   ...
   public void doPost(HttpServletRequest request, 
      ...
      while ( i.hasNext () ) 
      {
         ...
         if ( !fi.isFormField () )	
         {
            ...
            System.out.println( "src with filepath : " + src);
      ...
      /*Ends*/
      response.sendRedirect(request.getContextPath()+"/User/File_upload_message.jsp");
   }catch(Exception ex) {
  ...
  /*      throw new ServletException("GET method used with " +
	   ...
	   response.sendRedirect(request.getContextPath()+"/User/Client_Fileupload.jsp");
