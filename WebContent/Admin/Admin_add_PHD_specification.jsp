...
<title>Add PHD field Specification</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Add PHD field Specification</h3>
				</div>
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/PHD_field_specification_Controller" method="post" >
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="PHDFieldSpecificationName" id="CountryName">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="PHDFieldSpecificationDescription" class="required form-control"></textarea>
						</div>
					</div>
					
					<input type="hidden" value="add_PHD_field_specification" name="flag"/> 		
