...
<script type="text/javascript" src="js/application/jquery-ui.min.js"></script>
				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="layout_boxed.jsp">Boxed layout <span class="label label-danger">New</span></a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Boxed layout <small>Page example with boxed layout</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="layout_boxed.jsp">Layouts</a></li>
