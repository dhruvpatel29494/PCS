...
<title>Update University for UG</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Update University for UG</h3>
				</div>
			...
			<!-- Form validation -->
			<c:forEach items="${sessionScope.edit_UG_university }" var="x">
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/University_for_UG_Controller" method="post" >
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>

                		<div class="form-group">
						<label class="col-sm-2 control-label">UG field Specification: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <select name="UGFieldSpecificationId" class="required form-control">
                                <option value="${x.add_UG_field_specification_VO.UG_field_specification_id }">${x.add_UG_field_specification_VO.UG_field_specification_name }</option> 
                               	<c:forEach items="${sessionScope.search_UG_field_specification_UG_university }" var="i">
                 		...
                 		<div class="form-group">
						<label class="col-sm-2 control-label">Specialize Course name for UG:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <select name="SpecializeCourseNameForUG" class="required form-control">
                                 <option value="${x.add_specialize_course_for_UG_VO.specialize_course_for_UG_id }">${x.add_specialize_course_for_UG_VO.specialize_course_for_UG_name }</option>
                               	<c:forEach items="${sessionScope.search_Specialize_course_for_UG_university }" var="i">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="UniversityName" id="CountryName" value="${x.university_for_UG_name }">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="UniversityDescription" class="required form-control">${x.university_for_UG_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="UniversityForUGId" value="${x.university_for_UG_id }" />
					<input type="hidden" name="flag" value="update_university_for_UG" />
