                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete Job-seeker</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_all_jobseeker_details }" var="i">
				                    	<tr>
				                    		<td>${i.jobseeker_id }</td>
				                    		<td>${i.first_name }</td>
				                    		<td>${i.city_id.city_name }</td>
				                    		<td>${i.specialize_course_for_UG_id.specialize_course_for_UG_name }</td>
				                    		<td>${i.specialize_course_for_PG_id.specialize_course_for_PG_name }</td>
				                    		<td>${i.specialize_course_for_PHD_id.specialize_course_for_PHD_name }</td>
				                    		<td>${i.company_name  }</td>
				                    		<td>${i.experience}</td>	
											<td>
				                            <a href="#">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/Jobseeker_Controller?flag=delete_jobseeker&jobseeker_id=${i.jobseeker_id}">DELETE</a>
											</td>
