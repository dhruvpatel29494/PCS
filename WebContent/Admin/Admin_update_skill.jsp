...
<title>Update Skill</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<!-- Form validation -->
			<c:forEach items="${sessionScope.edit_skill }" var="x">
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/Skill_Controller" method="post">
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>

                	
					<div class="form-group">
						<label class="col-sm-2 control-label">Skill Name:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="SkillName" id="CountryName" value="${x.skill_name }">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">Skill Description: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="SkillDescription" class="required form-control">${x.skill_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="SkillId" value="${x.skill_id }"/>
					<input type="hidden" name="flag" value="update_skill"/>
