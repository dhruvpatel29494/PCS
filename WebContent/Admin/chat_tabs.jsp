				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="chat_tabs.jsp">Chat with tabs</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Messages with tabs <small>Chat page layout with user tabs</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="chat_tabs.jsp">Messages</a></li>
					<li class="active">Chat with tabs</li>
				</ul>
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#eugene" data-toggle="tab"><img src="images/face3.png" alt="" class="tab-img"> Eugene Kopyov <span class="status status-danger"></span></a></li>
                    <li><a href="#samantha" data-toggle="tab"><img src="images/face1.png" alt="" class="tab-img"> Samantha Smith <span class="status status-info"></span></a></li>
                    <li><a href="#vince" data-toggle="tab"><img src="images/face5.png" alt="" class="tab-img"> Vince Armstrong <span class="status status-warning"></span></a></li>
                    <li><a href="#mark" data-toggle="tab"><img src="images/face2.png" alt="" class="tab-img"> Mark Zugler <span class="status status-default"></span></a></li>
                    <li><a href="#sam" data-toggle="tab"><img src="images/face4.png" alt="" class="tab-img"> Sam Weeky <span class="status status-success"></span></a></li>
                </ul>
                <div class="tab-content">

                	<!-- First tab -->
                    <div class="tab-pane active fade in" id="eugene">
                    ...
                    <!-- Second tab -->
                    <div class="tab-pane fade" id="samantha">
                    ...
                    <!-- Third tab -->
                    <div class="tab-pane fade" id="vince">
