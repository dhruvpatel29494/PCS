				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="sidebar_narrow_left.jsp">Left narrow sidebar</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Narrow left sidebar <small>Narrow sidebar aligned to the left</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="sidebar_narrow_left.jsp">Layouts</a></li>
					<li class="active">Narrow left sidebar</li>
				</ul>
			...
			<div class="callout callout-info fade in">
				...
				<h5>Narrow left sidebar layout</h5>
				<p>Page layout with left aligned narrow sidebar, with hover trigger and 4 level navigation.</p>
			</div>
            <!-- /callout -->
