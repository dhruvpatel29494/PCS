...
<title>Edit &amp; Delete Role</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Search Role</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete Role</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_role }" var="i">
				                    	<tr>
				                    		<td>${i.role_id }</td>
				                    		<td>${i.role_name }</td>
				                            ...
				                            <a href="<%=request.getContextPath()%>/Role_Controller?flag=edit_role&role_id=${i.role_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/Role_Controller?flag=delete_role&role_id=${i.role_id}">DELETE</a>	
