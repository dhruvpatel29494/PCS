...
<title>Update University for PHD</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Update University for PHD</h3>
				</div>
			...
			<!-- Form validation -->
			<c:forEach items="${sessionScope.edit_PHD_university }" var="x">
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/University_for_PHD_Controller" method="post" >
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>

                		<div class="form-group">
						<label class="col-sm-2 control-label">PHD field Specification: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <select name="PHDFieldSpecificationId" class="required form-control">
                                <option value="${x.add_PHD_field_specification_VO.PHD_field_specification_id }">${x.add_PHD_field_specification_VO.PHD_field_specification_name }</option> 
                               	<c:forEach items="${sessionScope.search_PHD_field_specification_PHD_university }" var="i">
                 		...
                 		<div class="form-group">
						<label class="col-sm-2 control-label">Specialize Course name for PHD:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <select name="SpecializeCourseNameForPHD" class="required form-control">
                                 <option value="${x.add_specialize_course_for_PHD_VO.specialize_course_for_PHD_id }">${x.add_specialize_course_for_PHD_VO.specialize_course_for_PHD_name }</option>
                               	<c:forEach items="${sessionScope.search_Specialize_course_for_PHD_university }" var="i">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="UniversityName" id="CountryName" value="${x.university_for_PHD_name }">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="UniversityDescription" class="required form-control">${x.university_for_PHD_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="UniversityForPHDId" value="${x.university_for_PHD_id }" />
					<input type="hidden" name="flag" value="update_university_for_PHD" />
