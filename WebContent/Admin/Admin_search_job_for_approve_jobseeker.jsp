		...
		<div class="page-content">
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Shortlist Job-seekers</a></li>
                </ul>
				                ...
				                <table class="table">
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_job }" var="i">
				                    		<tr>
				                    			<td>${i.job_id }</td>
				                    			<td><img width="56" height="56" src="<%=request.getContextPath() %>/doc/${i.company_id.company_logo_path}" class="attachment-jobboard-related-company-logo-thumbnail wp-post-image" alt="3docean" /></td>
				                    			...
				                    			<td>
				                            		<a href="<%=request.getContextPath()%>/Apply_controller?flag=seach_applied_jobseekers&job_id=${i.job_id}">Next</a>
												</td>
				                    		</tr>
				                    	</c:forEach>
