...
<title>Edit &amp; Delete PHD specification.jsp</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3> Manage PHD field specification </h3>
				</div>
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Search PHD field specification</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete PHD field specification</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    <thead>
				                        <tr>
				                            <th>id</th>
				                            <th>PHD Specification Name</th>
				                            <th>PHD Specification Description</th>
				                            <th>Action</th>
				                        </tr>
				                    </thead>
				                    ...
				                    <tbody>
				                       <c:forEach items="${sessionScope.search_PHD_field_specification }" var="i">
				                    	<tr>
				                    		<td>${i.PHD_field_specification_id }</td>
				                    		<td>${i.PHD_field_specification_name }</td>
				                    		<td>${i.PHD_field_specification_description }</td>
				                    		<td>	
				                            
				                            <a href="<%=request.getContextPath()%>/PHD_field_specification_Controller?flag=edit_PHD_field_specification&PHD_field_specification_id=${i.PHD_field_specification_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/PHD_field_specification_Controller?flag=delete_PHD_field_specification&PHD_field_specification_id=${i.PHD_field_specification_id}">DELETE</a>	
