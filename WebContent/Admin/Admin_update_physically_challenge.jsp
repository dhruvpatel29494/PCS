...
<title>Update Physically Challenge</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Update Physically Challenge</h3>
				</div>
			</div>
			<!-- /page header -->
			...
			<!-- Form validation -->
			<c:forEach items="${sessionScope.edit_physically_challenge }" var="x">
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/Physically_challenge_Controller" method="post">
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>

                	
					<div class="form-group">
						<label class="col-sm-2 control-label">physically_challenge Name:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="PhysicallyChallengeName" id="CountryName" value="${x.physically_challenge_name }">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">physically_challenge Description: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="PhysicallyChallengeDescription" class="required form-control">${x.physically_challenge_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="PhysicallyChallengeId" value="${x.physically_challenge_id }"/>
					<input type="hidden" name="flag" value="update_physically_challenge"/>
