...
<title>Add Physically Challenge</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Add Physically Challenge</h3>
				</div>
			</div>
			<!-- /page header -->
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/Physically_challenge_Controller" method="post">
	            <div class="block">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Physically Challenge Name:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="PhysicallyChallengeName" id="CountryName">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">Physically Challenge Description: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="PhysicallyChallengeDescription" class="required form-control"></textarea>
						</div>
					</div>

					<input type="hidden" name="flag" value="add_physically_challenge"/>
