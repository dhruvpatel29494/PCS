				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="blank_collapsed_sidebar.jsp">Collapsed sidebar</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Collapsed sidebar <small>Collapsed sidebar blank page</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="blank_collapsed_sidebar.jsp">Blank pages</a></li>
			...
			<div class="callout callout-danger fade in">
				...
				<h5>Collapsed sidebar blank page</h5>
