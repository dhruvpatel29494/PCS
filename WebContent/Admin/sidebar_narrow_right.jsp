...
<body class="sidebar-narrow sidebar-right">
				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="sidebar_narrow_right.jsp">Right narrow sidebar</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Narrow right sidebar <small>Narrow sidebar aligned to the right</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="sidebar_narrow_right.jsp">Layouts</a></li>
					<li class="active">Narrow right sidebar</li>
				</ul>
			...
			<div class="callout callout-info fade in">
				...
				<h5>Narrow right sidebar layout</h5>
				<p>Page layout with right aligned narrow sidebar, with hover trigger and 4 level navigation.</p>
			</div>
            <!-- /callout -->
