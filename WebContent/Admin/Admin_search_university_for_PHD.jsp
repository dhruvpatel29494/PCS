...
<title>Edit &amp; Delete University for PHD</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3> Manage University for PHD </h3>
				</div>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete University for PHD</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    <thead>
				                        <tr>
				                            <th>PHD University id</th>
				                            <th>PHD University Name</th>
				                            <th>PHD University Description</th>
				                            <th>PHD field Specification Name</th>
				                            <th>PHD Specialize Course Name</th>
				                            <th>Action</th>
				                        </tr>
				                    </thead>
				                    ...
				                    <tbody>
				                        <c:forEach items="${sessionScope.search_PHD_university }" var="i">
				                    	<tr>
				                    		<td>${i.university_for_PHD_id }</td>
				                    		<td>${i.university_for_PHD_name }</td>
				                    		<td>${i.university_for_PHD_description }</td>
				                    		<td>${i.add_specialize_course_for_PHD_VO.specialize_course_for_PHD_name }</td>
				                    		<td>${i.add_PHD_field_specification_VO.PHD_field_specification_name }</td>
				                    		
				                    		<td>	
				                            
				                            <a href="<%=request.getContextPath()%>/University_for_PHD_Controller?flag=edit_university_for_PHD&university_for_PHD_id=${i.university_for_PHD_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/University_for_PHD_Controller?flag=delete_university_for_PHD&university_for_PHD_id=${i.university_for_PHD_id}">DELETE</a>	
