...
<title>Update PG field Specification</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Update PG field Specification</h3>
				</div>
			...
			<!-- Form validation -->
			<c:forEach items="${sessionScope.edit_PG_field_specification }" var="x">
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/PG_field_specification_Controller" method="post" >
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>
                	
					<div class="form-group">
						<label class="col-sm-2 control-label">PG field Specification Name:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="PGFieldSpecificationName" id="CountryName" value=${x.PG_field_specification_name }>
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">PG field Specification Description: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="PGFieldSpecificationDescription" class="required form-control">${x.PG_field_specification_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="PGfieldSpecificationId" value="${x.PG_field_specification_id }"/>
 					<input type="hidden" name="flag" value="update_PG_field_specification"/>
