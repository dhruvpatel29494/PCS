...
<title>Update Sub-category</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<!-- Form validation -->
			<c:forEach items="${sessionScope.edit_subcategory }" var="x">
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/Subcategory_Controller" method="post" >
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>

                		<div class="form-group">
						<label class="col-sm-2 control-label">Select Add Category : <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <select name="CategoryId" class="required form-control">
								...
								<c:forEach items="${sessionScope.search_category_for_subcategory }" var="i">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Subcategory Name:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="SubcategoryName" id="CountryName" value="${x.subcategory_name }">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">Subcategoty Description: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="SubcategotyDescription" class="required form-control">${x.subcategory_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="SubcategoryId" value="${x.subcategory_id }">
					<input type="hidden" name="flag" value="update_subcategory"/> 
