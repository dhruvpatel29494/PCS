...
<title>Edit &amp; Delete UG Specialization Course</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3> Manage UG Specialization Course </h3>
				</div>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete UG Specialization Course</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    <thead>
				                        <tr>
				                            <th>UG Specialization Course id</th>
				                            <th>UG Specialization Course Name</th>
				                            <th>UG Specialization Course Description</th>
				                            <th>UG field Specification Name</th>
				                            <th>Action</th>
				                        </tr>
				                    </thead>
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_specialize_course_for_UG }" var="i">
				                    		<tr>
				                    			<td>${i.specialize_course_for_UG_id }</td>
				                    			<td>${i.specialize_course_for_UG_name }</td>
				                    			<td>${i.specialize_course_for_UG_description }</td>
				                    			<td>${i.add_UG_field_specification_VO.UG_field_specification_name }</td>
				                    			<td>	
				                            
				                            <a href="<%=request.getContextPath()%>/Specialize_course_for_UG_Controller?flag=edit_Specialize_course_for_UG&specialize_course_for_UG_id=${i.specialize_course_for_UG_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/Specialize_course_for_UG_Controller?flag=delete_Specialize_course_for_UG&specialize_course_for_UG_id=${i.specialize_course_for_UG_id}">DELETE</a>	
