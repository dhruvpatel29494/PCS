...
<title>Edit &amp; Delete Skill</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Search Skill</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete Skill</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_skill }" var="i">
				                    		<tr>
				                    			<td>${i.skill_id }</td>
				                    			<td>${i.skill_name }</td>
				                    			<td>${i.skill_description }</td>
												<td>	
				                            
				                            <a href="<%=request.getContextPath()%>/Skill_Controller?flag=edit_skill&skill_id=${i.skill_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/Skill_Controller?flag=delete_skill&skill_id=${i.skill_id}">DELETE</a>	
