				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="form_grid.jsp">Inputs grid</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Inputs grid <small>Label position and inputs grid</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li class="active">Inputs grid</li>
				</ul>
			...
			<div class="callout callout-danger fade in">
				...
				<h5>Form inputs grid</h5>
				<p>By default all form elements can be placed inside <code>.col-md-*</code> blocks. Another words default Bootstrap responsive grid could be applied to form components.</p>
			</div>
            <!-- /callout -->
			...
			<form action="#" class="form-horizontal" role="form">
	            <div class="panel panel-default">
	                <div class="panel-heading"><h6 class="panel-title"><i class="icon-grid"></i> Default input grid</h6></div>
            ...
            <form action="#" class="form-horizontal" role="form">
                <div class="row">
                    <div class="col-lg-6">
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-paragraph-right"></i> Right aligned</h6></div>
			                <div class="panel-body rtl-inputs">
                    ...
                    <div class="col-lg-6">
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-paragraph-left"></i> Left aligned</h6></div>
			                <div class="panel-body">
			...
			<!-- Row label (default form) -->
			<form role="form" action="#">
	            <div class="panel panel-default">
	                <div class="panel-heading"><h6 class="panel-title"><i class="icon-pencil3"></i> Row label</h6></div>
	                <div class="panel-body">
			...
			<form role="form" action="#">
	            <div class="panel panel-default">
	                <div class="panel-heading"><h6 class="panel-title"><i class="icon-pencil3"></i> Input label</h6></div>
	                <div class="panel-body">
	            ...
	            <div class="panel panel-default">
	                ...
	                <div class="panel-body">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="row">
									<label class="col-md-4 control-label text-right">Label: </label>
									<div class="col-md-8">
										<input type="text" class="form-control" placeholder="col-md-2">
									</div>
								</div>
