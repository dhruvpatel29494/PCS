				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="wysiwyg.jsp">WYSIWYG editor</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>WYSIWYG editors <small>Different variations of WYSIWYG editor</small></h3>
				</div>
			...
			<div class="callout callout-danger fade in">
				...
				<h5>WYSIWYG editors</h5>
				<p>Content editors are based on awesome WYSIHTML5 plugin. Default examples of editor - inside and outside panel, in modal dialog.</p>
			</div>
            <!-- /callout -->


	        <!-- WYSIWYG editor -->
			<form class="block" action="#" role="form">
