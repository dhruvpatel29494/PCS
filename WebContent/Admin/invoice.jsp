			...
			<div class="sidebar-content">
				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							<li class="active"><a href="invoice.jsp">Invoice template</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Invoice template <small>Paid and unpaid invoice templates</small></h3>
				</div>
	        ...
	        <div class="panel panel-success">
		        <div class="panel-heading">
			        <h6 class="panel-title"><i class="icon-checkmark3"></i> Paid invoice</h6>
                	<div class="dropdown pull-right">
                    	<a href="#" class="dropdown-toggle panel-icon" data-toggle="dropdown">
	                    	<i class="icon-cog3"></i> 
	                    	<b class="caret"></b>
					...
					<div class="row">
						...
						<div class="col-sm-3">
							...
							<ul>
								...
								<li>Responsible: <a href="#" class="pull-right">Eugene Kopyov</a></li>
								<li>Issued by: <a href="#" class="pull-right">Jennifer Notes</a></li>
								<li class="chosen-payment">Payment method: <div class="pull-right"><span>Wire transfer</span> <a href="#">(change)</a></div></li>
								<li class="invoice-status"><strong>Current status: <span class="label label-success pull-right">Paid on 12 July 2013</span></strong></li>
							</ul>
						</div>
					</div>
				...
				<div class="panel-body">
					<div class="row invoice-payment">
						<div class="col-sm-8">
							<h6 class="text-success"><i class="icon-checkmark3"></i> Paid on July 14 2013</h6>
							<label class="radio">
								<input type="radio" name="payment-paid" class="styled">
								Checkout with Google
							</label>
							<label class="radio">
								<input type="radio" name="payment-paid" class="styled">
							...
							<label class="radio disabled">
								<input type="radio" name="payment-paid" disabled="disabled" class="styled" checked="checked">
								Wire transfer
							</label>
							<label class="radio">
								<input type="radio" name="payment-paid" class="styled">
						...
						<div class="col-sm-4">
							...
							<div class="btn-group pull-right">
								<button type="button" class="btn btn-info"><i class="icon-checkmark3"></i> Payment confirmed!</button>
								<button type="button" class="btn btn-primary"><i class="icon-print2"></i> Print</button>
							</div>
						</div>
					</div>
