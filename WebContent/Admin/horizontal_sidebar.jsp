		...
		<ul class="nav navbar-nav collapse" id="navbar-menu">
			...
			<li class="dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						...
						<li><a href="sidebar_collapsed.jsp">Collapsed sidebar</a></li>
						<li><a href="layout_fixed_navbar.jsp">Fixed navbar</a></li>
						<li><a href="horizontal_navigation.jsp">Horizontal navigation</a></li>
						<li class="active"><a href="horizontal_sidebar.jsp">Sidebar &amp; Horizontal navigation</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Sidebar with horizontal nav <small>Horizontal navigation with sidebar</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="horizontal_sidebar.jsp">Layouts</a></li>
					<li class="active">Sidebar &amp; horizontal nav</li>
				</ul>
			...
			<div class="callout callout-info fade in">
				...
				<h5>Page layout with horizontal nav and sidebar</h5>
				<p>Page layout example with togglable sidebar and horizontal multilevel navigation.</p>
			</div>
            <!-- /callout -->
