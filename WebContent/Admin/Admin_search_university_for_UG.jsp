...
<title>Edit &amp; Delete University for UG</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3> Manage University for UG </h3>
				</div>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete University for UG</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    <thead>
				                        <tr>
				                            <th>UG University id</th>
				                            <th>UG University Name</th>
				                            <th>UG University Description</th>
				                            <th>UG field Specification Name</th>
				                            <th>UG Specialize Course Name</th>
				                            <th>Action</th>
				                        </tr>
				                    </thead>
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_UG_university }" var="i">
				                    	<tr>
				                    		<td>${i.university_for_UG_id }</td>
				                    		<td>${i.university_for_UG_name }</td>
				                    		<td>${i.university_for_UG_description }</td>
				                    		<td>${i.add_specialize_course_for_UG_VO.specialize_course_for_UG_name }</td>
				                    		<td>${i.add_UG_field_specification_VO.UG_field_specification_name }</td>
				                    		
				                    		<td>	
				                            
				                            <a href="<%=request.getContextPath()%>/University_for_UG_Controller?flag=edit_university_for_UG&university_for_UG_id=${i.university_for_UG_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/University_for_UG_Controller?flag=delete_university_for_UG&university_for_UG_id=${i.university_for_UG_id}">DELETE</a>	
