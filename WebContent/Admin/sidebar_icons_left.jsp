				...
				<ul class="navigation navigation-icons-left">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="sidebar_icons_left.jsp">Left aligned icons</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Left aligned icons <small>Sidebar with left aligned icons</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="sidebar_icons_left.jsp">Layouts</a></li>
					<li class="active">Left icons sidebar</li>
				</ul>
			...
			<div class="callout callout-info fade in">
				...
				<h5>Layout with left aligned icons in wide sidebar</h5>
				<p>Page layout with left aligned icons inside wide sidebar.</p>
			</div>
            <!-- /callout -->
