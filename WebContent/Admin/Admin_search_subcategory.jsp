...
<title>Edit &amp; Delete Sub-category</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Search Sub-category</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete Sub-category</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_subcategory }" var="i">
				                    	<tr>
				                    		<td>${i.subcategory_id }</td>
				                    		<td>${i.subcategory_name }</td>
				                    		<td>${i.subcategory_description }</td>
				                    		<td>${i.category_id.category_name }</td>
				                    		<td>	
				                            
				                            <a href="<%=request.getContextPath()%>/Subcategory_Controller?flag=edit_subcategory&subcategory_id=${i.subcategory_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/Subcategory_Controller?flag=delete_subcategory&subcategory_id=${i.subcategory_id}">DELETE</a>	
