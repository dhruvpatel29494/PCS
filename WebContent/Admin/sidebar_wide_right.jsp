				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="sidebar_wide_right.jsp">Right wide sidebar</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Wide right sidebar <small>Wide sidebar aligned to the right</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="sidebar_wide_right.jsp">Layouts</a></li>
					<li class="active">Wide right sidebar</li>
				</ul>
			...
			<div class="callout callout-info fade in">
				...
				<h5>Wide right sidebar layout</h5>
				<p>Page layout with right aligned wide sidebar, with right aligned icons and 4 level navigation.</p>
			</div>
            <!-- /callout -->
