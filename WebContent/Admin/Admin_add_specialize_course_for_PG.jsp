...
<title>Add Specialize Course for PG</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Add Specialize Course for PG</h3>
				</div>
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/Specialize_course_for_PG_Controller" method="post" >
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="SpecializeCourseNameForPG" id="CountryName">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="SpecializeCourseDescriptionForPG" class="required form-control"></textarea>
						</div>
					</div>
					
					<input type="hidden" name="flag" value="Specialize_course_for_PG"/>	
