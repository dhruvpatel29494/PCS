				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="blank_right_sidebar.jsp">Right sidebar</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Right wide sidebar <small>Wide right sidebar blank page</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="blank_wide_right.jsp">Blank pages</a></li>
					<li class="active">Wide right</li>
				</ul>
				...
				<ul class="breadcrumb-buttons collapse">
					<li class="dropdown">
						...
						<div class="popup dropdown-menu dropdown-menu-right">
							...
							<form action="#" class="breadcrumb-search" method="get">
			...
			<div class="callout callout-danger fade in">
				...
				<h5>Wide right sidebar blank page</h5>
