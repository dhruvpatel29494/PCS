...
<title>Edit &amp; Delete State</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
				                        ...
				                        <c:forEach items="${sessionScope.search_state }" var="i">
				                        	<tr>
				                        		...
				                        		<td>	
				                            		...
				                            		<a href="<%=request.getContextPath()%>/State_Controller?flag=edit_state&state_id=${i.state_id}">EDIT</a> 
													/ <a href="<%=request.getContextPath()%>/State_Controller?flag=delete_state&state_id=${i.state_id}">DELETE</a>	
