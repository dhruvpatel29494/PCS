...
<title>Add Specialize Course for UG</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Add Specialize Course for UG</h3>
				</div>
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/Specialize_course_for_UG_Controller" method="post" >
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="SpecializeCourseNameForUG" id="CountryName">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="SpecializeCourseDescriptionForUG" class="required form-control"></textarea>
						</div>
					</div>
					
					<input type="hidden" name="flag" value="add_specialize_course_for_UG"/>
