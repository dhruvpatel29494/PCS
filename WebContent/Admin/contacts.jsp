				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="contacts.jsp">Contact list</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Contact list <small>List of contacts with details</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="contacts.jsp">User</a></li>
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#list_view" data-toggle="tab"><i class="icon-paragraph-justify2"></i> List of contacts</a></li>
                    <li><a href="#table_view" data-toggle="tab"><i class="icon-stack"></i> Table with contacts</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="list_view">
					    ...
					    <!-- Contacts (list) -->
						<div class="block">
							<h6><i class="icon-bubbles4"></i> Chat layout with contact list</h6>
					    	<ul class="message-list">
					    		...
					    		<li>
					                ...
					                <div class="panel-collapse collapse in" id="lucy_smith">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face3.png" alt=""></a>
					                            <div class="message-body">
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											...
											<h6>James Jameson <span class="status status-warning"></span> <small>&nbsp; /&nbsp; Engineer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#james_jameson"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="james_jameson">
					                	<div class="chat">
					                    	<div class="message">
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face8.png" alt=""></a> 
					                ...
					                <div class="panel-collapse collapse" id="barbara_madison">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face8.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face9.png" alt=""></a> 
											<h6>James Willings <span class="status status-warning"></span> <small>&nbsp; /&nbsp; Engineer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#james_willings"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="james_willings">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face9.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					                ...
					                <div class="panel-collapse collapse" id="malik_smitsons">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face11.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face12.png" alt=""></a> 
											<h6>Ian Lake <span class="status status-success"></span> <small>&nbsp; /&nbsp; Wed developer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#ian_lake"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="ian_lake">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face12.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face13.png" alt=""></a> 
											<h6>Leonard Cooper <span class="status status-default"></span> <small>&nbsp; /&nbsp; Usability expert</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#leonard_cooper"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="leonard_cooper">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face13.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face15.png" alt=""></a> 
											<h6>Marshall Clayton <span class="status status-success"></span> <small>&nbsp; /&nbsp; Wed developer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#marhsall_clayton"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="marhsall_clayton">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face15.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face16.png" alt=""></a> 
					                ...
					                <div class="panel-collapse collapse" id="barnaba_pall">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face16.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face17.png" alt=""></a> 
											<h6>Sean McSambey <span class="status status-warning"></span> <small>&nbsp; /&nbsp; Engineer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#sean_mcsambey"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="sean_mcsambey">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face17.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face18.png" alt=""></a> 
											<h6>Shawn Pauling <span class="status status-default"></span> <small>&nbsp; /&nbsp; Usability expert</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#sean_pauling"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="sean_pauling">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face18.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face19.png" alt=""></a> 
											<h6>Paul Winslow <span class="status status-danger"></span> <small>&nbsp; /&nbsp; Wed developer</small></h6>
										</div>
										<div class="chat-actions">
											<a class="btn btn-link btn-icon btn-xs" data-toggle="collapse" href="#paul_winslow"><i class="icon-bubble3"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-phone2"></i></a>
											<a href="#" class="btn btn-link btn-icon btn-xs"><i class="icon-camera5"></i></a>
										</div>
					            	</div>

					                <div class="panel-collapse collapse" id="paul_winslow">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face19.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face20.png" alt=""></a> 
					                ...
					                <div class="panel-collapse collapse" id="xenia_robson">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face20.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face21.png" alt=""></a> 
					                ...
					                <div class="panel-collapse collapse" id="michael_carlson">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face21.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
					    		...
					    		<li>
					            	<div class="clearfix">
					            		<div class="chat-member">
											<a href="#"><img src="images/face22.png" alt=""></a> 
					                ...
					                <div class="panel-collapse collapse" id="duke_aaron">
					                	<div class="chat">
					                    	<div class="message">
					                            <a class="message-img" href="#"><img src="images/face22.png" alt=""></a>
					                            <div class="message-body">
													<span class="typing"></span>
					                            </div>
					                        </div>
                	...
                	<div class="tab-pane fade" id="table_view">
			            ...
			            <!-- Contacts (table) -->
			        	<div class="block">
			        		<h6 class="heading-hr"><i class="icon-people"></i> Contacts. Table view</h6>
