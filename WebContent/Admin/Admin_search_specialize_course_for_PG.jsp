...
<title>Edit &amp; Delete PG Specialization Course</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3> Manage PG Specialization Course </h3>
				</div>
                ...
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete PG Specialization Course</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    <thead>
				                        <tr>
				                            <th>PG Specialization Course id</th>
				                            <th>PG Specialization Course Name</th>
				                            <th>PG Specialization Course Description</th>
				                    ...
				                    <tbody>
				                        <c:forEach items="${sessionScope.search_specialize_course_for_PG }" var="i">
				                    		<tr>
				                    			<td>${i.specialize_course_for_PG_id }</td>
				                    			<td>${i.specialize_course_for_PG_name }</td>
				                    			<td>${i.specialize_course_for_PG_description }</td>
				                    			<td>${i.add_PG_field_specification_VO.PG_field_specification_name }</td>
				                    			<td>	
				                            
				                            <a href="<%=request.getContextPath()%>/Specialize_course_for_PG_Controller?flag=edit_Specialize_course_for_PG&specialize_course_for_PG_id=${i.specialize_course_for_PG_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/Specialize_course_for_PG_Controller?flag=delete_Specialize_course_for_PG&specialize_course_for_PG_id=${i.specialize_course_for_PG_id}">DELETE</a>	
