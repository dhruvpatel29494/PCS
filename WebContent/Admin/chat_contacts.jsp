				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="chat_contacts.jsp">Chat with contacts</a></li>
						</ul>
					</li>
					<li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Messages with contacts <small>Chat page layout with contact list</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="chat_contacts.jsp">Messages</a></li>
					<li class="active">Chat with contacts</li>
				</ul>
