...
<title>Update PHD field Specification</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Update PHD field Specification</h3>
				</div>
			...
			<!-- Form validation -->
    		<c:forEach items="${sessionScope.edit_PHD_field_specification }" var="x">
    		<form class="form-horizontal validate" action="<%=request.getContextPath() %>/PHD_field_specification_Controller" method="post" >
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>
                	
					<div class="form-group">
						<label class="col-sm-2 control-label">PHD field Specification Name:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="PHDFieldSpecificationName" id="CountryName" value="${x.PHD_field_specification_name }">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">PHD field Specification Description: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="PHDFieldSpecificationDescription" class="required form-control">${x.PHD_field_specification_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="PHDfieldSpecificationId" value="${x.PHD_field_specification_id }"/>
					<input type="hidden" value="update_PHD_field_specification" name="flag"/> 		
