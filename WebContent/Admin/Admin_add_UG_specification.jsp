...
<title>Add UG field Specification</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Add UG field Specification</h3>
				</div>
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/UG_field_specification_Controller"  method="post">
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="UGFieldSpecificationName" id="CountryName">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="UGFieldSpecificationDescription" class="required form-control"></textarea>
						</div>
					</div>
					
					<input type="hidden" name="flag" value="add_UG_field_specification"/>
