...
<title>Update Country</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
            ...
            <c:forEach items="${sessionScope.edit_country }" var="x">
			
				                        
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/Country_Controller" method="post" >
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="CountryName" id="CountryName" value="${x.country_name }">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label">Country Description: <span class="mandatory">*</span></label>
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="CountryDescription" class="required form-control" >${x.country_description }</textarea>
						</div>
					</div>

					<input type="hidden" name="CountryId" value="${x.country_id }"> 
					<input type="hidden" name="flag" value="update_country"> 
