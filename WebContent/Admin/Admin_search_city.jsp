...
<title>Edit &amp; Delete City</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
				                ...
				                <table class="table">
				                    ...
				                    <tbody>
				                    	...
				                    	<tr>
				                            ...
				                            <a href="<%=request.getContextPath()%>/City_Controller?flag=edit_city&city_id=${i.city_id}">EDIT</a> 
											/ <a href="<%=request.getContextPath()%>/City_Controller?flag=delete_city&city_id=${i.city_id}">DELETE</a>	
