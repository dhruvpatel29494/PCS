...
<script type="text/javascript" src="js/vertical_bars.js"></script>
<script type="text/javascript" src="js/horizontal_bars.js"></script>
<script type="text/javascript" src="js/simple_graph.js"></script>
<script type="text/javascript" src="js/auto_filled.js"></script>
<script type="text/javascript" src="js/auto_empty.js"></script>
<script type="text/javascript" src="js/multiple_axes.js"></script>

<script type="text/javascript" src="js/animated_1.js"></script>
<script type="text/javascript" src="js/animated_2.js"></script>
<script type="text/javascript" src="js/animated_3.js"></script>

<script type="text/javascript" src="js/donut.js"></script>
<script type="text/javascript" src="js/pie.js"></script>
<script type="text/javascript" src="js/pie_full.js"></script>

<script type="text/javascript" src="js/filled_green.js"></script>
<script type="text/javascript" src="js/filled_red.js"></script>
<script type="text/javascript" src="js/filled_blue.js"></script>
		...
		<div class="sidebar">
			<div class="sidebar-content">
				...
				<ul class="navigation">
					...
					<li class="active"><a href="charts.jsp"><span>Charts</span> <i class="icon-bars"></i></a></li>
					<li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Charts &amp; graphs <small>Graphic and charts based on Flot library</small></h3>
				</div>
			...
			<div class="callout callout-info fade in">
				...
				<p>Page example with styled graphs and charts, based on Sparkline and Flot chart jquery plugins.</p>
			</div>
            <!-- /callout -->
	    	...
	    	<div class="row">
	    		<div class="col-md-4">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Animated graph 1</h6>
				        </div>
	    		...
	    		<div class="col-md-4">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Animated graph 2</h6>
				        </div>
				        <div class="panel-body">
			...
			<div class="row">
				<div class="col-md-6">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Vertical bars</h6>
				        </div>
				        <div class="panel-body">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Simple chart</h6>
				        </div>
				        <div class="panel-body">
				...
				<div class="col-md-6">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Horizontal bars</h6>
				        </div>
				        <div class="panel-body">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Multiple axes</h6>
				        </div>
				        <div class="panel-body">
					        <div class="graph-standard" id="multiple_axes"></div>
				        </div>
			        </div>
			        <!-- /auto updating graph (empty) -->
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Filled updating graph</h6>
				        </div>
				        <div class="panel-body">
			...
			<div class="row">
				<div class="col-md-4">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Donut</h6>
				        </div>
				        <div class="panel-body">
					        <div class="graph-standard" id="donut"></div>
				        </div>
			        </div>
			        <!-- /donut -->
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Filled green graph</h6>
				        </div>
				        <div class="panel-body">
				...
				<div class="col-md-4">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Pie</h6>
				        </div>
				        <div class="panel-body">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Filled red graph</h6>
				        </div>
				        <div class="panel-body">
				...
				<div class="col-md-4">
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Pie full</h6>
				        </div>
				        <div class="panel-body">
					        <div class="graph-standard" id="pie_full"></div>
				        </div>
			        </div>
			        <!-- /pie -->
			        ...
			        <div class="panel panel-default">
				        <div class="panel-heading">
					        <h6 class="panel-title"><i class="icon-calendar2"></i> Filled blue graph</h6>
				        </div>
				        <div class="panel-body">
