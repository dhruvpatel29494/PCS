				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="gallery.jsp">Media gallery</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Gallery <small>Image and video gallery</small></h3>
				</div>
			...
			<div class="callout callout-info fade in">
				...
				<h5>Image and video gallery</h5>
				<p>Media gallery page example with custom toolbar. Includes layout - with/without backgrounds, with title, without title, gallery style and table view.</p>
			</div>
            <!-- /callout -->
		                            ...
		                            <tbody>
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face1.png" alt="" class="img-media"></a>
					                        </td>
		                                ...
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face2.png" alt="" class="img-media"></a>
					                        </td>
		                                ...
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face3.png" alt="" class="img-media"></a>
					                        </td>
					                        <td><a href="#" title="">Image1 description</a></td>
					                        <td>Feb 12, 2012. 12:28</td>
					                        <td class="file-info">
		                                ...
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face4.png" alt="" class="img-media"></a>
					                        </td>
					                        <td><a href="#" title="">Image1 description</a></td>
					                        <td>Feb 12, 2012. 12:28</td>
					                        <td class="file-info">
		                                ...
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face5.png" alt="" class="img-media"></a>
					                        </td>
					                        <td><a href="#" title="">Image1 description</a></td>
					                        <td>Feb 12, 2012. 12:28</td>
					                        <td class="file-info">
		                                ...
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face6.png" alt="" class="img-media"></a>
					                        </td>
					                        <td><a href="#" title="">Image1 description</a></td>
					                        <td>Feb 12, 2012. 12:28</td>
					                        <td class="file-info">
		                                ...
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face7.png" alt="" class="img-media"></a>
					                        </td>
					                        <td><a href="#" title="">Image1 description</a></td>
					                        <td>Feb 12, 2012. 12:28</td>
					                        <td class="file-info">
		                                ...
		                                <tr>
					                        <td class="text-center">
						                        <a href="images/demo/big.jpg" class="lightbox"><img src="images/face8.png" alt="" class="img-media"></a>
					                        </td>
					                        <td><a href="#" title="">Image1 description</a></td>
					                        <td>Feb 12, 2012. 12:28</td>
					                        <td class="file-info">
