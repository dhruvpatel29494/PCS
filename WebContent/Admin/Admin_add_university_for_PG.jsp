	            ...
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>
						...
						<div class="col-sm-10">
                 		...
                 		<div class="form-group">
						<label class="col-sm-2 control-label">Specialize Field name for PG:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
					...
					<input type="hidden" name="flag" value="add_university_for_PG" />
