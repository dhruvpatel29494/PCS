...
<title>Edit &amp; Delete Category</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Search Category</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete Category</h6><span style="color:red"><%=session.getAttribute("validation") %></span></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
				                    	<c:forEach items="${sessionScope.search_category }" var="i">
				                    		<tr>
				                    			<td>${i.category_id }</td>
				                    			...
				                    			<td>	
				                            		...
				                            		<a href="<%=request.getContextPath()%>/Category_Controller?flag=edit_category&category_id=${i.category_id}">EDIT</a> 
													/ <a href="<%=request.getContextPath()%>/Category_Controller?flag=delete_category&category_id=${i.category_id}">DELETE</a>	
												</td>
				                    		</tr>
				                    	</c:forEach>
				                    </tbody>
