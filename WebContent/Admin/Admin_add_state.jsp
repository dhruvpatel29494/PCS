...
<title>Add State</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
            ...
            <form class="form-horizontal validate" action="<%=request.getContextPath() %>/State_Controller" method="post" >
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="StateName" id="CountryName">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="StateDescription" class="required form-control"></textarea>
						</div>
					</div>
			
					<input type="hidden" name="flag" value="add_state"/>		
