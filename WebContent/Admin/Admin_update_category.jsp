...
<title>Update Category</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<!-- Form validation -->
			<c:forEach items="${sessionScope.edit_category }" var="x">
            <form class="form-horizontal validate" action="<%=request.getContextPath()%>/Category_Controller" method="post" >
	            <div class="block">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="CategoryName" id="CountryName" value="${x.category_name }">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="CategoryDescription" class="required form-control">${x.category_description }</textarea>
						</div>
					</div>
					
					<input type="hidden" name="CategoryId" value="${x.category_id }">	
					<input type="hidden" name="flag" value="edit_catagory"/>
