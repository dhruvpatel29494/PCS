				...
				<ul class="navigation">
					...
					<li class="disabled">
						...
						<ul>
							...
							<li class="disabled"><a href="form_layouts.jsp">Form layouts</a></li>
							<li><a href="form_grid.jsp">Inputs grid</a></li>
							<li class="disabled"><a href="wysiwyg.jsp">WYSIWYG editor</a></li>
							<li><a href="validation.jsp">Validation</a></li>
							<li class="disabled"><a href="file_uploader.jsp">Multiple file uploader</a></li>
					...
					<li>
						...
						<ul>
							...
							<li class="disabled"><a href="navbars.jsp">Navbars</a></li>
							<li><a href="info_blocks.jsp">Info blocks</a></li>
							<li class="disabled"><a href="icons.jsp">Icons <span class="label label-danger">850+</span></a></li>
							<li class="disabled"><a href="buttons.jsp">Buttons</a></li>
							<li><a href="calendar.jsp">Calendar</a></li>
							<li><a href="typography.jsp">Typography</a></li>
							<li class="disabled"><a href="gallery.jsp">Media gallery</a></li>
					...
					<li>
						...
						<ul>
							...
							<li class="disabled"><a href="sidebar_wide_right.jsp">Right wide sidebar</a></li>
							<li><a href="sidebar_narrow_left.jsp">Left narrow sidebar</a></li>
							<li class="disabled"><a href="sidebar_narrow_right.jsp">Right narrow sidebar</a></li>
							<li class="disabled"><a href="sidebar_icons_left.jsp">Left aligned icons</a></li>
							<li><a href="layout_boxed.jsp">Boxed layout <span class="label label-danger">New</span></a></li>
							<li class="disabled"><a href="layout_fixed_navbar.jsp">Fixed navbar</a></li>
							<li><a href="horizontal_navigation.jsp">Horizontal navigation</a></li>
							<li class="disabled"><a href="horizontal_sidebar.jsp">Sidebar &amp; Horizontal navigation</a></li>
							<li class="active"><a href="navigation_disabled_items.jsp">Disabled navigation items</a></li>
						</ul>
					</li>
					<li>
					...
					<li class="disabled"><a href="search.jsp"><span>Search page</span> <i class="icon-search3"></i></a></li>
					<li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Disabled nav items <small>Example of disabled navigation items</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="navigation_disabled_items.jsp">Layouts</a></li>
					<li class="active">Disabled nav items</li>
				</ul>
			...
			<div class="callout callout-info fade in">
				...
				<h5>Disabled navigation menu items</h5>
				<p>If you need to disable any of navigation menu items, just add <code>class="disabled"</code> to nav list item, this will turn off default link action and hide all children levels. See main navigation on the left.</p>
			</div>
            <!-- /callout -->
