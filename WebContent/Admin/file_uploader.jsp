				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
							...
							<li class="active"><a href="file_uploader.jsp">Multiple file uploader</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Multiple file uploader <small>Basic examples of multiple file uploader</small></h3>
				</div>
			...
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					...
					<li><a href="file_uploader.jsp">Forms</a></li>
					<li class="active">Multiple file uploader</li>
				</ul>
			...
			<div class="callout callout-danger fade in">
				...
				<h5>Multiple file uploader</h5>
				<p>Multiple file uploader examples - default without header, uploader with header and uploader inside panel. All uploader styles are flexible and fully customizable via CSS.</p>
			</div>
            <!-- /callout -->
			...
			<div class="block">	
				<h6><i class="icon-upload"></i> Multiple file uploader</h6>
			...
			<div class="block">	
				<h6><i class="icon-upload3"></i> Uploader with header</h6>
