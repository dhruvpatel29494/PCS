...
<title>Edit &amp; Delete Country</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
		...
		<div class="page-content">
            ...
            <div class="tabbable page-tabs">
                <ul class="nav nav-tabs">
	                <li class="active"><a href="#inside" data-toggle="tab"><i class="icon-checkbox-partial"></i> Search Country</a></li>
                </ul>
                <div class="tab-content">
                	...
                	<div class="tab-pane active fade in" id="inside">
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Edit &amp; Delete Country</h6></div>
			                <div class="datatable-add-row">
				                <table class="table">
				                    ...
				                    <tbody>
				                        <c:forEach items="${sessionScope.search_country }" var="i">
				                        	<tr>
				                        		<td>${i.country_id}</td>
				                        		<td>${i.country_name}</td>
				                        		<td>${i.country_description}</td>
				                        		<td>	
				                            
				                            		<a href="<%=request.getContextPath()%>/Country_Controller?flag=edit_country&country_id=${i.country_id}">EDIT</a> 
												   /<a href="<%=request.getContextPath()%>/Country_Controller?flag=delete_country&country_id=${i.country_id}">DELETE</a>	
