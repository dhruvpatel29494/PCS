...
<title>Add University</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/Admin/images/logo_tab.png" />
	            ...
	            <div class="block">
	                <h6 class="heading-hr"><i class="icon-checkmark-circle"></i> Form validation</h6>
						...
						<div class="col-sm-10">
                 		...
                 		<div class="form-group">
						<label class="col-sm-2 control-label">Specialize Field name for PHD:<span class="mandatory">*</span></label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="required form-control" name="UniversityName" id="CountryName">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
                            <textarea rows="5" cols="5" name="UniversityDescription" class="required form-control"></textarea>
						</div>
					</div>
					
					<input type="hidden" name="flag" value="add_university_for_PHD" />
