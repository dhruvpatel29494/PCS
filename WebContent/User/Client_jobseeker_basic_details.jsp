			...
			<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						...
						<input value="${j.first_name }" id="company_phone" type="text" class="form-control" name="FirstName" />
					</div>
					<div class="col-md-6 form-group">
						<label for="company_email">Last Name</label>
						<input value="${j.last_name }" id="company_email" type="text" class="form-control" name="LastName" />
					</div>
				</div><!-- /.row -->
				...
				<div class="form-group">
						...
						<textarea name="Address" id="CompanyProfile" class="form-control" rows="7" required="required">${j.address }</textarea>
				</div><!-- /.form-group -->
				...
				<div class="form-group">
						...
						<input class="form-control" type="text" name="KeySkills" id="title" value="${j.key_skills }" placeholder="Please seperate by comma"/>
				</div><!-- /.form-group -->
					...
					<input type="hidden" name="flag" id="form_type" value="update_job-seeker_basic_details" />
