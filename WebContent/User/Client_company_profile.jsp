	...
	<div class="container">
		...
		<div id="company-header">
			...
			<div id="company-main-logo">
								...
								<a href="<%=request.getContextPath() %>/Company_Controller?flag=profile_view&CompanyId=${sessionScope.CompanyId}"><img src="<%=request.getContextPath() %>/doc/${j.company_logo_path}" width="191" height="58" alt="${j.company_name }" /></a>
		...
		<div class="row abount-company-content">
			...
			<div class="col-md-6">
				<h2 class="sub-section-title uppercase">Contact Information</h2>

				<article>
					
				</article>
			
			<div class="jobboard_company_map_locator" style="width: 570px;" >
				...
				<div class="inner">
					...
					<ul>
						<li class="jb_map_address"><i class="fa fa-map-marker"></i> ${j.company_address }</li>
						<li class="jb_map_phone"><i class="fa fa-mobile"></i> <a href="tel:${j.company_contact_no }">${j.company_contact_no }</a></li>
						<li class="jb_map_contact"><i class="fa fa-globe"></i> ${j.company_email }</li>
					</ul>
...
<c:forEach items="${sessionScope.company_profile }" var="j">
	<div class="container">
		...
		<h1 class="jobboard-section-title uppercase">Expertise</h1>
				...
				<div class="section-subtitle">${j.company_headline }</div>
		
		<ul class="company_experience_group">
					
					<c:forTokens items="${j.company_expertises }" delims="," var="k">
							<li>${k }</li>
