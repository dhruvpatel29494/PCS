...
<head>
	...
	<title>  Job-seeker's Education Details</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="row">
						...
						<input type="hidden" name="flag" id="form_type" value="update_job-seeker_education_details" />
