...
<body class="single single-job postid-231 logged-in">
	...
	<c:forEach items="${sessionScope.information_about_single_job }" var="i">	
		<form action="<%=request.getContextPath()%>/Apply_controller" method="post">
	...
	<div class="container">
		...
		<div class="company-job-detail clearfix">
			...
			<a href="#"><img width="160" height="48" src="<%=request.getContextPath() %>/doc/${i.company_id.company_logo_path}" class="attachment-jobboard-job-detail-company wp-post-image" alt="3docean" /></a>			</div><!-- /.company-logo -->
