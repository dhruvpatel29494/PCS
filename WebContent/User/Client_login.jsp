...
<head>
	...
	<title>  Login</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-5">
				...
				<div id="login-error-box" class="alert alert-danger"><strong>ERROR</strong>: Wrong Email or password.</div> 
					</c:if>
				<div id="login-form-wrapper" class="no-animated">

					<form id="login-form" action="abc" method="post">
						<div class="form-group">
							<input class="form-control" type="email" name="Email" id="user_login" placeholder="Email" required="required" />
						</div><!-- /.form-group -->
						<div class="form-group">
						...
						<input type="hidden" name="flag" value="jobseeker_login" />
						
						
						<input type="submit" value="Log in" class="btn btn-login">  <a href="<%=request.getContextPath() %>/User/Client_password_recovery.jsp" style="color: white;padding-left: 10px;">Forget Password? </a>
					</form>
...
<p><a href="<%=request.getContextPath() %>/User/Client_register.jsp" target="_self" class="btn sc-button medium grey">REGISTER</a></p>
<div class="row">
<div class="col-sm-6 col-sm-offset-0">
<ul class="sc-ul">
<li><i style="color:#1abc9c" class="fa fa-fw fa-arrow-right"></i> Post your CV anywhere, anytime</li>
<li><i style="color:#1abc9c" class="fa fa-fw fa-arrow-right"></i> Communication threw Email and SMS</li>
<li><i style="color:#1abc9c" class="fa fa-fw fa-arrow-right"></i> MNC companies are waiting for You</li>
...
<li><i style="color:#1abc9c" class="fa fa-fw fa-arrow-right"></i> Shortlist jobseeker according to requirement</li>
<li><i style="color:#1abc9c" class="fa fa-fw fa-arrow-right"></i> Reduce HR's workflow</li>
<li><i style="color:#1abc9c" class="fa fa-fw fa-arrow-right"></i> Advertisement of jobs</li>
</ul>
</div>
</div>
					</article>
