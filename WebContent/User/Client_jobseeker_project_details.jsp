...
<head>
	...
	<title>  Job-seeker's Project Details</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
			...
			<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input value="${j.company_name_buyer }" id="company_phone" type="text" class="form-control" name="CompanyNameBuyer" />
					</div>
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input value="${j.project_title }" id="company_phone" type="text" class="form-control" name="ProfileTitle" />
					</div>
				...
				<div class="form-group">
					...
					<textarea id="job_overview" class="form-control" rows="7" name="ProjectSummary">${j.project_summary }</textarea>
				</div>
				
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="company_phone">Position(Role)</label>
						<input value="${j.position_in_project }" id="company_phone" type="text" class="form-control" name="Position" />
					</div>
				...
				<div class="form-group">
					...
					<textarea id="job_overview" class="form-control" rows="7" name="RoleDetails">${j.role_details }</textarea>
				</div>
				
				<div class="row">
					<div class="col-md-12 form-group">
						<label for="company_phone">Team Size</label>
						<input value="${j.time_size }" id="company_phone" type="text" class="form-control" name="TeamSize" />
					</div>
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input value="${j.skills }" id="company_phone" type="text" class="form-control" name="Skills" />
					</div>
					
				</div><!-- /.row -->
				
								
				<input type="hidden" name="flag" id="form_type" value="update_job-seeker_project_details" />
