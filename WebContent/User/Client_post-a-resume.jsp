...
<head>
	...
	<title>  Post A Resume</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
		...
		<div class="row">
			<div class="col-md-8">
				<form method="post" class="frontend-form" action="" id="post-resume" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="name">Resume Title</label>
						<input class="form-control" type="text" name="title" id="title" value="" />
					</div><!-- /.form-group -->
					...
					<div class="form-group">
						...
						<input class="form-control" required="required" type="text" name="job_title" id="job_title" value="" />
					</div><!-- /.form-group -->
					...
					<div class="row">
						<div class="form-group col-sm-4">
							...
							<option value="contract" >Contract</option><option value="freelance" >Freelance</option><option value="full-time" >Full Time</option><option value="part-time" >Part Time</option>							</select>
						</div><!-- /.col-sm-6 -->
						<div class="form-group col-sm-4">
					...
					<div class="form-group">
						...
						<input class="form-control" required="required" type="text" name="location" id="location" value="" />
					</div><!-- /.form-group -->
					...
					<div class="form-group">
						<label for="category">Resume Category</label>
						<select class="form-control" name="category">
							<option value="">Select Category</option>
						<option value="finance-head" >Finance Head</option><option value="front-end-developer" >Front End Developer</option><option value="sales-manager" >Sales Manager</option><option value="web-design" >Web Designer</option><option value="web-developer" >Web Developer</option>						</select>
					</div><!-- /.form-group -->

					<div class="form-group">
						<label for="content">Resume Content</label>
						<!-- <textarea name="content" class="form-control" rows="6"></textarea> -->
						<div id="wp-resume_content-wrap" class="wp-core-ui wp-editor-wrap tmce-active"><link rel='stylesheet' id='dashicons-css'  href='http://demo.puriwp.com/jobboard/wp-includes/css/dashicons.min.css?ver=4.0.1' type='text/css' media='all' />
<link rel='stylesheet' id='editor-buttons-css'  href='http://demo.puriwp.com/jobboard/wp-includes/css/editor.min.css?ver=4.0.1' type='text/css' media='all' />
...
<div id="wp-resume_content-editor-tools" class="wp-editor-tools hide-if-no-js"><div class="wp-editor-tabs"><a id="resume_content-html" class="wp-switch-editor switch-html" onclick="switchEditors.switchto(this);">Text</a>
<a id="resume_content-tmce" class="wp-switch-editor switch-tmce" onclick="switchEditors.switchto(this);">Visual</a>
</div>
</div>
<div id="wp-resume_content-editor-container" class="wp-editor-container"><textarea class="form-control wp-editor-area" rows="20" autocomplete="off" cols="40" name="resume_content" id="resume_content"></textarea></div>
</div>
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="skills" id="skills" placeholder="Use comma to separate" value="" />
					</div><!-- /.forn-group -->

					<div class="form-group">
						<label for="year_experience">Year Experience (<i>number value</i>)</label>
						<input class="form-control" required="required" type="text" name="year_experience" id="year_experience" placeholder="Example: 5" value="" />
					</div><!-- /.forn-group -->

					<div class="form-group">
						<label for="proposed_monthly_sallary">Proposed monthly sallary</label>
						<input class="form-control" required="required" type="text" name="proposed_monthly_sallary" id="proposed_monthly_sallary" value="" />
					</div><!-- /.forn-group -->
					...
					<div class="form-group">
						...
						<button type="button" id="add_url_button" class="btn btn-add-url" data-limit="5" data-form-id="#url_form" >+ Add URL</button>
					</div><!-- /.form-group -->
						...
						<div class="row">
							<div class="form-group col-md-6">
								<label for="education_period">Education Period</label>
								<input type="text"  class="form-control" name="education_period[]" />
							</div><!-- /.form-group -->
							<div class="form-group col-md-6">
								<label for="education_grade">Grade/GPA</label>
								<input type="text" class="form-control" name="education_grade[]" />
							</div><!-- /.form-group -->
						</div><!-- /.row -->

						<div class="form-group">
							<label for="education_name">Institution Name</label>
							<input type="text" class="form-control" name="education_name[]" />
						</div><!-- /.form-group -->
						<div class="form-group">
							<label for="education_qualification">Qualification(s)</label>
							<input type="text" class="form-control" name="education_qualification[]" />
						</div><!-- /.form-group -->
						<div class="form-group">
							<label for="education_study">Field of Study</label>
					...
					<div class="form-group">
						...
						<button type="button" id="add_education_button" class="btn btn-add-url" data-form-id="#education_form">+ Add Education</button>
					</div><!-- /.form-group -->
					...
					<div id="experience_form" class="repeated-form">
						...
						<div class="row">
							<div class="form-group col-md-6">
								<label for="experience_period">Employment Period</label>
								<input type="text" class="form-control" name="experience_period[]" />
							</div><!-- /.form-group -->
							<div class="form-group col-md-6">
								<label for="experience_sallary">Yearly Sallary</label>
						...
						<div class="form-group">
							<label for="experience_job">Job Duties</label>
							<textarea name="experience_job[]" class="form-control" rows="6"></textarea>
						</div><!-- /.form-group -->
					</div><!-- /.experience_form -->
					<div class="form-group">
						<label for="experience">Experience</label>
						<button type="button" id="add_experience_button" class="btn btn-add-url" data-form-id="#experience_form">+ Add Experience</button>
					</div><!-- /.form-group -->
					...
					<div class="form-group">
						...
						<span class="help-block">Optionally upload your resume for employers to view</span>
					</div><!-- /.form-group -->
										<input type="hidden" name="form_type" id="form_type" value="post_resume" />
					<input type="hidden" name="user_id" id="user_id" value="1672" />
