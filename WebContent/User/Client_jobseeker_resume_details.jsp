...
<head>
	...
	<title>  Job-seeker's Resume Details</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
...
<div id="content">
	<div class="container">
		<div class="row">
			...
			<c:forEach var="j" items="${sessionScope.JobseekerDetails }">	
				...
				<div class="row">
					<div class="col-md-12 form-group">
						...
						<input value="${j.resume_title }" id="company_phone" type="text" class="form-control" name="Title" />
					</div>
				...
				<input type="hidden" name="flag" id="form_type" value="update_jobseeker_resume_details" />
