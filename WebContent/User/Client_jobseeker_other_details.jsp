...
<head>
	...
	<title>  Job-seeker's Other Details</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
			...
			<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-3 form-group">
						...
						<input value="${j.language0 }" id="company_phone" type="text" class="form-control" name="Language[0]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Speak</center></label>
						<input value="${j.speak0 }" id="company_email" type="checkbox" class="form-control" name="Speak[0]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Read</center></label>
						<input value="${j.read0 }" id="company_email" type="checkbox" class="form-control" name="Read[0]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Write</center></label>
						<input value="${j.write0 }" id="company_email" type="checkbox" class="form-control" name="Write[0]" />
					</div>
					<div class="col-md-3 form-group">
				...
				<div class="row">
					<div class="col-md-3 form-group">
						<label for="company_phone"><center>Language Name</center></label>
						<input value="${j.language1 }" id="company_phone" type="text" class="form-control" name="Language[1]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Speak</center></label>
						<input value="${j.speak1 }" id="company_email" type="checkbox" class="form-control" name="Speak[1]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Read</center></label>
						<input value="${j.read1 }" id="company_email" type="checkbox" class="form-control" name="Read[1]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Write</center></label>
						<input value="${j.write1 }" id="company_email" type="checkbox" class="form-control" name="Write[1]" />
					</div>
					<div class="col-md-3 form-group">
						<label for="company_email"><center>Mother Tounge</center></label>
				...
				<div class="row">
					<div class="col-md-3 form-group">
						<label for="company_phone"><center>Language Name</center></label>
						<input value="${j.language2 }" id="company_phone" type="text" class="form-control" name="Language[2]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Speak</center></label>
						<input value="${j.speak2 }" id="company_email" type="checkbox" class="form-control" name="Speak[2]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Read</center></label>
						<input value="${j.read2 }" id="company_email" type="checkbox" class="form-control" name="Read[2]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Write</center></label>
						<input value="${j.write2 }" id="company_email" type="checkbox" class="form-control" name="Write[2]" />
					</div>
					<div class="col-md-3 form-group">
						<label for="company_email"><center>Mother Tounge</center></label>
				...
				<div class="row">
					<div class="col-md-3 form-group">
						<label for="company_phone"><center>Language Name</center></label>
						<input value="${j.language3 }" id="company_phone" type="text" class="form-control" name="Language[3]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Speak</center></label>
						<input value="${j.speak3 }" id="company_email" type="checkbox" class="form-control" name="Speak[3]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Read</center></label>
						<input value="${j.read3 }" id="company_email" type="checkbox" class="form-control" name="Read[3]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Write</center></label>
						<input value="${j.write3 }" id="company_email" type="checkbox" class="form-control" name="Write[3]" />
					</div>
					<div class="col-md-3 form-group">
						<label for="company_email"><center>Mother Tounge</center></label>
				...
				<div class="row">
					<div class="col-md-3 form-group">
						<label for="company_phone"><center>Language Name</center></label>
						<input value="${j.language4 }" id="company_phone" type="text" class="form-control" name="Language[4]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Speak</center></label>
						<input value="${j.speak4 }" id="company_email" type="checkbox" class="form-control" name="Speak[4]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Read</center></label>
						<input value="${j.read4 }" id="company_email" type="checkbox" class="form-control" name="Read[4]" />
					</div>
					<div class="col-md-2 form-group">
						<label for="company_email"><center>Write</center></label>
						<input value="${j.write4 }" id="company_email" type="checkbox" class="form-control" name="Write[4]" />
					</div>
					<div class="col-md-3 form-group">
						<label for="company_email"><center>Mother Tounge</center></label>
						<input value="Select[3]" id="company_email" type="radio" class="form-control" name="MotherTounge" />
				...
				<div class="form-group">
					...
					<textarea id="job_overview" class="form-control" rows="7" name="CategoryDescription">${j.category_description }</textarea>
				</div>
				
								
				<input type="hidden" name="flag" id="form_type" value="update_job-seeker_other_details" />
