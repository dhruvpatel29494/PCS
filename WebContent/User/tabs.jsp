...
<head>
	...
	<link rel="stylesheet" href="tab/css/reset.css"> <!-- CSS reset -->
...
<div class="cd-tabs">
	<nav>
		<ul class="cd-tabs-navigation">
			<li><a data-content="inbox" class="selected" href="#0" id="tabb">Inbox</a></li>
			<li><a data-content="new" href="#0" id="tabb">New</a></li>
			<li><a data-content="gallery" href="#0" id="tabb">Gallery</a></li>
			<li><a data-content="store" href="#0" id="tabb">Store</a></li>
			<li><a data-content="settings" href="#0" id="tabb">Settings</a></li>
			<li><a data-content="trash" href="#0" id="tabb">Trash</a></li>
...
<script src="tab/js/jquery-2.1.1.js"></script>
<script src="tab/js/main.js"></script> <!-- Resource jQuery -->
</body>
</html>