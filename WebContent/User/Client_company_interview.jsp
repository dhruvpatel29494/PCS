...
<head>
	...
	<title>  Interview Schedule</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
	...
	<div class="container">
		...
		<div class="jobs-listing-wrapper">
			<div id="job-listing-tabs">
				<ul>
				<li><a href="#all_jobs">All</a></li></ul>
				<div id="all_jobs">
						<c:forEach items="${sessionScope.all_shortlisted_jobseeker_for_job }" var="i">
									<div class="job-listing-row clearfix">
						<div class="job-company-logo">
						<img width="56" height="56" src="<%=request.getContextPath() %>/doc/${i.jobseeker_id.profile_pic}" class="attachment-jobboard-related-company-logo-thumbnail wp-post-image" alt="3docean" />	
						</div><!-- /.job-company-logo -->
						<div class="job-listing-name">
							<h4>${i.jobseeker_id.first_name }</h4>	
							<p class="job-listing-summary"></p>	
						</div><!-- /.job-listing-name -->
						<div class="job-listing-region">
							<i class="fa fa-fw fa-map-marker"></i>
							${i.jobseeker_id.city_id.city_name }						</div><!-- /.job-listing-region -->
						<div class="job-listing-type">
							<i class="fa fa-fw fa-user"></i>
							${i.jobseeker_id.experience }						</div><!-- /.job-listing-type -->
						<div class="job-listing-view">
							<a href="<%=request.getContextPath() %>/Job_Controller?flag=search_single_job&JobId=${i.jobseeker_id.jobseeker_id}" class="btn btn-view-job">View Job</a>
					...
					<!-- /#job-listing-231 -->
						...
						<div class="job-listing-view">
							<a href="<%=request.getContextPath() %>/Job_Controller?flag=search_single_job&JobId=${i.job_id}" class="btn btn-view-job">View Job</a>
						</div><!-- /.job-listing-view -->
					</div>
					<!-- /#job-listing-231 -->
					</c:forEach>
...
<div id="featured-job">
	<div class="container">
		...
		<div class="clearfix featured-job-wrapper">
				<!-- /.featured-job-item -->
						<c:forEach items="${sessionScope.search_job_for_company }" var="i">
						<div class="featured-job-item">
					<div class="featured-job-thumbnail">
					<img width="350" height="150" src="<%=request.getContextPath() %>/doc/${i.company_id.company_logo_path}" class="attachment-jobboard-featured-job-thumbnail wp-post-image" alt="themeforest" />					</div>
					<div class="featured-job-detail">
						<div class="featured-job-title">${i.job_title }</div>
						<div class="featured-job-desc">${i.job_summary }</div>
						<a href="<%=request.getContextPath() %>/Job_Controller?flag=search_single_job&JobId=${i.job_id}" class="btn btn-view-featured-job">View Job</a>
					</div>
					<div class="featured-job-type clearfix">
							<div class="featured-job-location">
								<i class="fa fa-map-marker"></i>
								${i.city_id.city_name }							</div>
