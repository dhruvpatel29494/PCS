...
<head>
	...
	<title>  Account Settings</title><link rel="shortcut icon" type="image/x-icon" href="<%=request.getContextPath() %>/User/images/logo_tab.png" />
...
<link rel="alternate" type="application/rss+xml" title="Job Board &raquo; Account Settings Comments Feed" href="http://demo.puriwp.com/jobboard/account-settings/feed/" />
...
<link rel='canonical' href='http://demo.puriwp.com/jobboard/account-settings/' />
<link rel='shortlink' href='http://demo.puriwp.com/jobboard/?p=377' />
...
<body class="page page-id-377 page-template page-template-page-templatestemplate-user-settings-php logged-in">
...
<form action="#" method="post" class="frontend-form">
  ...
  <p>
    ...
    <input id="username" type="text" disabled="disabled" name="username" value="hello123" class="form-control"></input>
  </p>

  <p>
    <label for="firstname">First Name: </label>
    <input id="firstname" type="text" name="firstname" value="" class="form-control"></input>
  </p>

  <p>
    <label for="lastname">Last Name: </label>
    <input id="lastname" type="text" name="lastname" value="" class="form-control"></input>
  </p>
  ...
  <p>
    ...
    <input id="email" type="text" name="email" value="AKASHPATEL0509@GMAIL.COM" class="form-control"></input>
  </p>
  ...
  <p><button type="submit" name="update_user" value="1" class="btn btn-send-contact-form" data-loading-text="Updating...">Update Profile</button>
  </p>
